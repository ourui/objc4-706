...
_dyld_objc_notify_register(
                           void (*handler_0)(unsigned count, 
                                             const char * const paths[],
                                             const struct mach_header * const mhdrs[]
                                             ), 
                           void (*handler_1)(const char *path, const struct mach_header *mh),
                           void (*func)(const char *path, const struct mach_header *mh)
                           );
    
extern int 
_dyld_is_memory_immutable(const char *str, size_t size);
